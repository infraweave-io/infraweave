...
def module_json_to_rst_table(module_name, module_json):
  json_data = convert_tf_module_to_json_schema(module_name, module_json)
...
cli_template = lambda module_name, module_json: f'''
{module_name}
=======
...
{module_json_to_rst_table(module_name, module_json)}
